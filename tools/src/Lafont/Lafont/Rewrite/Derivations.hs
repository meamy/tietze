...
addDepToGraph :: Dependency -> Rewrite -> DepGraph -> Either Dependency DepGraph
...
addDepsToGraph :: Dependency -> [Rewrite] -> DepGraph -> Either Dependency DepGraph
...
-- derivation.
addDerivationToGraph :: Derivation -> DepGraph -> Either Dependency DepGraph
...
addDerivationsToGraph :: [Derivation] -> DepGraph -> Either Dependency DepGraph
